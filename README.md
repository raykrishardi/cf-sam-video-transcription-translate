...
```bash
cf-sam-video-transcription-translate$ sam build
```
...
```bash
cf-sam-video-transcription-translate$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
cf-sam-video-transcription-translate$ sam logs -n HelloWorldFunction --stack-name cf-sam-video-transcription-translate --tail
```
...
```bash
sam delete --stack-name cf-sam-video-transcription-translate
```
